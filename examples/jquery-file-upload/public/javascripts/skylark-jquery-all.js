...
define('skylark-langx/langx',["./skylark"], function(skylark) {
  ...
  // Perform a deep comparison to check if two objects are equal.
    ...
    var XHRx = function(async) {
        // https://github.com/hustcc/xhr.js/blob/master/src/xhr.js
        /**
        ...
        **/
        var Result = function(xhrObj) {
            ...
            return {
                ...
                json: function() { return xhrObj.responseText ? JSON.parse(xhrObj.responseText) : null; },
        ...
        __on_request_callback = function() {
            if (_xhr.readyState === 4) {
                ...
                if ((_xhr.status >= 200 && _xhr.status < 300) || _xhr.status == 304 ) {
                    __callback_func('success')(result, _this);
                // fail
                } else {
                    __callback_func('fail')(result, _this);
                }
        ...
        **/
        request = function(method, url, params, onsuccess, onfail) {
            ...
            on('success', function(result){
                try {
                    _defer.resolve(result.json(),result); 
                } catch (e) {
                    console.log(e);
                }
        ...
        **/
        get = function(url, params, onsuccess, onfail) {
            ...
            if (params && params.query) {
                query = _params_2_url(params.query);
            } 
            if (query) {
                url = url + '?' + query;
            }
        ...
        * - url: the request url.
        * - params: the request params.
        * - onsuccess: when request su ccess.
        * - onfail: when request fail.
        *
        * How to use it?
        * var xhr = new require('xhr.js')();
        ...
        **/
        ...
        patch = function(url, params, onsuccess, onfail) {
            // if is string / formdata
            return request('PATCH', url, params, onsuccess, onfail);
        },

        put = function(url, params, onsuccess, onfail) {
            // if is string / formdata
            return request('PUT', url, params, onsuccess, onfail);
        },

        del = function(url, params, onsuccess, onfail) {
            // if is string / formdata
            return request('DELETE', url, params, onsuccess, onfail);
        },
